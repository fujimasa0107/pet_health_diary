...
## 背景
- 私自身ペットを飼っており、ペットに関する日々の記録や情報が一目で分かることで、ペットの健康管理をサポートできるアプリを作りたいと思いました。
...
## 画面遷移図
[![Image from Gyazo](https://i.gyazo.com/6dd8cc464145f8bc4d4f32c4e85ed455.png)](https://gyazo.com/6dd8cc464145f8bc4d4f32c4e85ed455)
## 開発環境
- 言語: Ruby, JavaScript
